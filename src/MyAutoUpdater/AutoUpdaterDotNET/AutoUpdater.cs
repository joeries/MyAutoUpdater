...
namespace AutoUpdaterDotNET
{
    ...
    public static class AutoUpdater
    {
                    ...
                    else
                    {
                        if (args != null)
                        {
                            ...
                            else
                            {
                                if (ReportErrors)
                                {
                                    MessageBox.Show(MyAutoUpdater.Properties.Resources.UpdateUnavailableMessage, MyAutoUpdater.Properties.Resources.UpdateUnavailableCaption,
                        ...
                        else
                        {
                            ...
                            {
                                MessageBox.Show(
                                    MyAutoUpdater.Properties.Resources.UpdateCheckFailedMessage,
                                    MyAutoUpdater.Properties.Resources.UpdateCheckFailedCaption, MessageBoxButtons.OK, MessageBoxIcon.Error);
                            }
                            Exit();
                        }
                    }
        ...
        private static void BackgroundWorkerDoWork(object sender, DoWorkEventArgs e)
        {
            ...
            InstalledVersion = new Version(Constants.CurVersion);
